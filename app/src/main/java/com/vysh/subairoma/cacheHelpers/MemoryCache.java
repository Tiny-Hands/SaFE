...
public final class MemoryCache {
    ...
    public MemoryCache() {
        //use 1/12 of available heap size
    ...
    public Bitmap get(String id) {
        try {
            if (!cache.containsKey(id)) {
                Log.d("mylog", "not found in cache: " + id);
                return null;
            }
            ...
            ex.printStackTrace();
            Log.d("mylog", "error in memcache: " + ex.getMessage());
            return null;
        }
    }
    ...
    public void put(String id, Bitmap bitmap) {
        try {
            ...
            //Log.d("mylog", "successfully put: " + id);
            checkSize();
        } catch (Throwable th) {
            Log.d("mylog", "error while putting: " + th.getMessage());
            th.printStackTrace();
        }
    }
