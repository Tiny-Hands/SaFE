            ...
            public void onResponse(String response) {
                try {
                    ...
                    if (jsonObject.getString("error").equalsIgnoreCase("true")) {
                        ...
                        if (userSex == null || userSex.equalsIgnoreCase("null"))
                            userSex = "";
                        String user_age = jsonObject.getString("user_age");
                        if (user_age == null || user_age.equalsIgnoreCase("null"))
                            user_age = "";
                        String userPhone = jsonObject.getString("user_phone");
                        if (userPhone == null || userPhone.equalsIgnoreCase("null"))
                            userPhone = "";
                        String userImg = jsonObject.getString("user_img");
                        if (userImg == null || userImg.equalsIgnoreCase("null"))
                            userImg = "";
